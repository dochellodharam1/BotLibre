...
public class Migrate {
    ...
    public EntityManagerFactory createEntityManagerFactory(String name) {
        ...
        properties.put(PersistenceUnitProperties.JDBC_DRIVER, AdminDatabase.DATABASE_DRIVER);
    ...
    public void initDatabase() {
        ...
        EntityManagerFactory postgres = createEntityManagerFactory("postgres");
        ...
        try {
            ...
            try {
                ...
                factory = createEntityManagerFactory("Bot");
    ...
    public void migrate() {
        ...
        properties.put(PersistenceUnitProperties.JDBC_PASSWORD, Site.DATABASEPASSWORD);
        //properties.put(PersistenceUnitProperties.LOGGING_LEVEL, "FINE");
        EntityManagerFactory factory = createEntityManagerFactory(Site.PERSISTENCE_UNIT);
    ...
    public void dropDeadSchemas() {
        try {
            ...
            EntityManagerFactory postgres = createEntityManagerFactory("postgres");
            EntityManager pg = postgres.createEntityManager();
            EntityManagerFactory botsFactory = createEntityManagerFactory(Site.PERSISTENCE_UNIT + "_bots");
    ...
    public void archiveInactive() {
        ...
        try {
            ...
            properties.put(PersistenceUnitProperties.LOGGING_LEVEL, "FINE");
            properties.put(PersistenceUnitProperties.JDBC_PASSWORD, Site.DATABASEPASSWORD);
            postgres = createEntityManagerFactory("postgres");
            botsFactory = createEntityManagerFactory(Site.PERSISTENCE_UNIT + "_bots");
            botsFactory.createEntityManager().close();
            factory = createEntityManagerFactory(Site.PERSISTENCE_UNIT);
    ...
    public void migrate4() {
        ...
        properties.put(PersistenceUnitProperties.JDBC_PASSWORD, Site.DATABASEPASSWORD);
        //properties.put(PersistenceUnitProperties.LOGGING_LEVEL, "FINE");
        EntityManagerFactory factory = createEntityManagerFactory("botlibre");
        EntityManager em = factory.createEntityManager();
        List<BotInstance> instances = em.createQuery("Select p from BotInstance p").getResultList();
        AdminDatabase.instance().log(Level.INFO, "Migrating", instances.size());
        int count = 0;
    ...
    public void migrate2() {
        EntityManagerFactory sourceFactory = createEntityManagerFactory("migration");
        Map<String, String> properties = new HashMap<String, String>();
        properties.put(PersistenceUnitProperties.JDBC_PASSWORD, Site.DATABASEPASSWORD);
        properties.put(PersistenceUnitProperties.DDL_GENERATION, PersistenceUnitProperties.DROP_AND_CREATE);
        properties.put(PersistenceUnitProperties.LOGGING_LEVEL, "fine");
        EntityManagerFactory targetFactory = createEntityManagerFactory("botlibre");
